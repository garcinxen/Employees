		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#employeesnamespace-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeesnamespace-display": {
								"semanticObject": "employeesnamespace",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeesnamespace",
									"url": sap.ui.require.toUrl("employeesnamespace")
								}
							}
						}
					}
